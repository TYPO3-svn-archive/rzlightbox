...
/**
 * Plugin 'jQuery Lightbox' for the 'rzcolorbox' extension.
 *
 * @author    Raphael Zschorsch <rafu1987@gmail.com>
 * @package    TYPO3
 * @subpackage    rzlightbox
 */
 
class tx_rzlightbox_pi1 extends tslib_pibase {
    var $prefixId      = 'tx_rzlightbox_pi1';
    var $scriptRelPath = 'pi1/class.tx_rzlightbox_pi1.php';
    var $extKey        = 'rzlightbox';
